        ...
        <div className="pt-4 pb-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-6xl mx-auto px-4">
                {categories.map((cat, index) => (
                    <div
                        key={index}
                        className="relative rounded-2xl shadow-md overflow-hidden bg-white aspect-[4/3] md:aspect-[5/4]"
                    >
                        {/* Shoe Image */}
                        <img
                            src={cat.image}
                        ...
                        <div className="absolute bottom-6 left-6 z-10">
                            <a
                                href="#"
                                className="flex items-center gap-2 text-sm md:text-base font-lato font-medium text-gray-800 hover:text-black"
                            >
